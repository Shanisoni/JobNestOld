      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h1 className='text-2xl font-bold'>Job<span className='text-[blue]'>Nest</span></h1>
            <p className="text-sm">© 2024 JobNest by Shani Soni. All rights reserved.
</p>
          </div>
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            ...
            <a href="https://x.com/shani_soni__" className="hover:text-gray-400" aria-label="Twitter">
            ...
            <a href="https://www.linkedin.com/in/shanisoni/" className="hover:text-gray-400" aria-label="LinkedIn">
